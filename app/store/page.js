...
<section className={classes.section}>
  ...
  <p>
    ...
    Proceeds directly support free multilingual ASL resources and community access initiatives.
  </p>
  ...
  <div className={classes.eventBlock}>
    ...
    <p>
      ...
      strengthening home communication, and building practical everyday vocabulary.
    </p>

    <p>
      <strong>Language:</strong> ASL with spoken Spanish support<br />
  ...
  <div className={classes.eventBlock}>
    ...
    <p>
      A 10-week ASL-based permit course taught fully in ASL.
      Prepares Deaf and hard-of-hearing students for the written permit exam
      using accessible, visual instruction.
    </p>

    <p>
      <strong>Format:</strong> Live on Zoom<br />
  ...
  {/* Algebra Workshop */}
<section className={classes.section}>
  <h3 id="algebra-workshop">Expressions, Equations & Algebraic Reasoning</h3>
